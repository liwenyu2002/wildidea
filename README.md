...
你可能会觉得这很暴力。事实上这也不是我凭空想的——2026 年 Shen et al. 发表了一篇论文 (*Unlocking LLM Creativity in Science through Analogical Reasoning*)，用类似思路证明了：先锁定外域机制再映射，比先理解问题再找类比，新颖率从 1.6% 提升到 >50%。我参考了他们的结构化映射和搜索约束等技术细节，但在这个基础上做了大量工程化改造——特别是去掉了他们"需要先提取问题结构"的步骤，直接从外域端随机映射，加上了自动化校验和去锚点纪律。

...
你可能会觉得这很暴力。WildIdea 的核心设计（不理解问题、直接从外域映射机制）是原创的。后续我们注意到 Shen et al. (2026) *Unlocking LLM Creativity in Science through Analogical Reasoning* 在思路上有相似之处——他们提出"先冻结源域再映射"，并证明了相比"先理解问题再找类比"能显著提高新颖率和多样性。我们参考了他们的技术细节（结构化映射、搜索约束、AR Dataset 用于扩充领域库），在此基础上加了工程化的校验和去锚点纪律。

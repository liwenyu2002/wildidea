...
This is the active agent skill spec v1.3. The Web app is a separate deployed product; this document preserves the original WildIdea skill workflow for agents. Treat the listed Python commands as internal helper scripts, not as the user-facing product experience.
